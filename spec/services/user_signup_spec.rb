  ...
  describe "#sign_up" do
    context "valid personal info and valid card" do
      ...
      it "creates the user" do
        UserSignup.new(Fabricate.build(:user)).sign_up(stripe_token: "some_stripe_token")
    ...
    context "with invalid personal info" do
      ...
      it "does not create the user" do
        UserSignup.new(User.new(name: "Tom Smith")).sign_up(stripe_token: "some_stripe_token")
        expect(User.count).to eq(0)
      end
