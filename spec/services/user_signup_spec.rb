  ...
  describe "#sign_up" do
    context "valid personal info and valid card" do
      ...
      it "makes the user follow the inviter" do
        ...
        UserSignup.new(Fabricate.build(:user, email: invitation.recipient_email)).sign_up("some_stripe_token", invitation.token)
      ...
      it "sends the email to the user with valid inputs" do
        UserSignup.new(Fabricate.build(:user, email: "vik@example.com")).sign_up("some_stripe_token", nil)
    ...
    context "with invalid personal info" do
      ...
      it "does not create the user" do
        UserSignup.new(User.new(name: "Tom Smith")).sign_up("some_stripe_token", nil)
        expect(User.count).to eq(0)
      end
